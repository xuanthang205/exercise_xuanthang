  ...
  var _ = {
    ...
    loopFix: function (e) {
      ...
      c.length < w + y || ('cards' === d.params.effect && c.length < w + 2 * y)
        ? g('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters')
    ...
    if (
      ...
      g > 0
        ? (b &&
            ...
            i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ('auto' !== r.slidesPerView && s.slides.length - r.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween : s.minTranslate()) &&
        ...
        : g < 0 &&
          (b &&
            ...
            i.allowThresholdMove &&
            i.currentTranslate <
              (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween + ('auto' !== r.slidesPerView && s.slides.length - r.slidesPerView >= 2 ? s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween : 0) : s.maxTranslate()) &&
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          m && !h
            ...
            : !m && h && (r.classList.add(`${i.containerModifierClass}grid`), ((u.grid.fill && 'column' === u.grid.fill) || (!u.grid.fill && 'column' === i.grid.fill)) && r.classList.add(`${i.containerModifierClass}grid-column`), e.emitContainerClasses()),
  ...
  const ve = [
    function (e) {
      ...
      function d(e, t) {
        ...
        let i;
        return (
          a.renderSlide ? ((i = a.renderSlide.call(s, e, t)), 'string' == typeof i && (C(o, i), (i = o.children[0]))) : (i = s.isElement ? v('swiper-slide') : v('div', s.params.slideClass)),
